...
public class Server implements Serializable {
     ...
     */
    public Server(String name, String owner, String serverId) {
        roles = new HashMap<>();
        roles.put(owner, "Owner");
        this.rolesName = new HashMap<>();
        rolesName.put("Owner", "1111111111");
    ...
    public void addUser(String name) {
        if(!name.equals(getOwner()))
            roles.put(name, "Member");
        else
            roles.put(name, "Owner");

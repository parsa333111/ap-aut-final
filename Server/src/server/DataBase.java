...
public class DataBase implements Serializable {
    ...
    public boolean checkRequest(ClientData client, String user) {
        for(String str : client.getFriendRequests()) {
            if(str.equals(user))
                return true;
        }
        return false;
     ...
     * @param file location
     */
    public void addFileToChannel(String owner, String chatId, String file) {
        ChatChannel chatChannel = getChannel(chatId);
        chatChannel.getMassages().add(new Massage(owner, file, "SendFile"));
    ...
    public void newReact(String user, String chatId, String massageId, String type) {
        int id = Integer.parseInt(massageId);
        ChatChannel chatChannel = getChannel(chatId);
        Massage massage = chatChannel.getMassages().get(id);
        massage.reactToMassage(user, type);
    }
}

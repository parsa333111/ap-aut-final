        ...
        public void run() {
            try {
                while (true) {
                    ...
                    System.out.println("*******notify : " + msg.getOwner() + " " + msg.getText());
                    if(msg instanceof MsgJoin) {
                        ...
                        sendNotification(msg.getOwner(), new MsgNotification(msg.getId(), msg.getOwner(), msg.getText()));
                    }
                }
